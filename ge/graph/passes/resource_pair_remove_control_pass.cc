...
namespace ge {
Status ResourcePairRemoveControlPass::Run(ComputeGraphPtr graph) {
  GE_CHECK_NOTNULL(graph);
  GELOGD("ResourcePairRemoveControlPass pass start.");
  ...
  // according type pair, find same prefix node, remove control edge
